...
switch (WebUI.waitForElementVisible(findTestObject('Object Repository/xpath_dynamic', ['xpath' : "//*[@id='pemegang-saham-matching-0']"]), 5, FailureHandling.OPTIONAL)) {
    case true:
...
String[] textValues = ['Watchlist', 'Watchlist Kendaraan', 'Plafond', 'Engine Scoring', 'BO']

for (String text : textValues) {
    WebUI.click(findTestObject('Object Repository/xpath_dynamic', ['xpath' : "//bcaf-matching-result//*[text()='" + text + "']"]))
}

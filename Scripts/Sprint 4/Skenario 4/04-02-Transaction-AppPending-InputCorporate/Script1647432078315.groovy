...
WebUI.takeFullPageScreenshotAsCheckpoint((userDir + GlobalVariable.sprint4WebScreenshootPath) + 'scenario-4-masuk-submenu-surat-keterangan-domisili.png')

KeywordUtil.markPassed('scenario 4 - Masuk submenu surat keterangan domisili')
...
'Melakukan screenshoot full page'
WebUI.takeFullPageScreenshotAsCheckpoint((userDir + GlobalVariable.sprint4WebScreenshootPath) + 'scenario-4-capture-surat-keterangan-domisili-berhasil.png')

KeywordUtil.markPassed('scenario 4 - Capture surat keterangan domisili berhasil')
...
'Melakukan screenshoot full page'
WebUI.takeFullPageScreenshotAsCheckpoint((userDir + GlobalVariable.sprint4WebScreenshootPath) + 'scenario-4-Masuk-submenu-FAP.png')

KeywordUtil.markPassed('scenario 4 - Masuk submenu FAP')
...
'Melakukan screenshoot full page'
WebUI.takeFullPageScreenshotAsCheckpoint((userDir + GlobalVariable.sprint4WebScreenshootPath) + 'scenario-4-Input-data-FAP.png')

KeywordUtil.markPassed('scenario 4 - Input data FAP')
...
'Melakukan screenshoot full page'
WebUI.takeFullPageScreenshotAsCheckpoint((userDir + GlobalVariable.sprint4WebScreenshootPath) + 'scenario-4-Input-data-alamat-pengirim-surat.png')

KeywordUtil.markPassed('scenario 4 - Input data alamat pengirim surat')
...
'Melakukan screenshoot full page'
WebUI.takeFullPageScreenshotAsCheckpoint((userDir + GlobalVariable.sprint4WebScreenshootPath) + 'scenario-4-Input-data-pengurus.png')

KeywordUtil.markPassed('scenario 4 - Input data pengurus')
...
'Melakukan screenshoot full page'
WebUI.takeFullPageScreenshotAsCheckpoint((userDir + GlobalVariable.sprint4WebScreenshootPath) + 'scenario-4-Masuk-submenu-data-pengurus-1.png')

KeywordUtil.markPassed('scenario 4 - Masuk submenu data pengurus 1')
...
WebUI.takeFullPageScreenshotAsCheckpoint((userDir + GlobalVariable.sprint4WebScreenshootPath) + 'scenario-4-Berhasil-input-otomatis-data-pengurus-berdasarkan-data-capture-ktp-pengurus-yang-di-capture.png')

KeywordUtil.markPassed('scenario 4 - Berhasil input otomatis data pengurus berdasarkan data capture ktp pengurus yang di capture ')
...
'Melakukan screenshoot full page'
WebUI.takeFullPageScreenshotAsCheckpoint((userDir + GlobalVariable.sprint4WebScreenshootPath) + 'scenario-4-Berhasil-input-otomatis-data-pengurus-1.png')

KeywordUtil.markPassed('scenario 4 - Berhasil input data pengurus 1')
...
'Melakukan screenshoot full page'
WebUI.takeFullPageScreenshotAsCheckpoint((userDir + GlobalVariable.sprint4WebScreenshootPath) + 'scenario-4-Masuk-Submenu-pemegang-saham-1.png')

KeywordUtil.markPassed('scenario 4 - Berhasil masuk menu pemegang saham ')
...
'Melakukan screenshoot full page'
WebUI.takeFullPageScreenshotAsCheckpoint((userDir + GlobalVariable.sprint4WebScreenshootPath) + 'scenario-4-Memilih-radio-button-pemegang-saham.png')

KeywordUtil.markPassed('scenario 4 - Memilih radio button pemegang saham')
...
KeywordUtil.markPassed('scenario 4 - Masuk submenu pemegang saham 1')
...
'Melakukan screenshoot full page'
WebUI.takeFullPageScreenshotAsCheckpoint((userDir + GlobalVariable.sprint4WebScreenshootPath) + 'scenario-4-Berhasil-pemegang-saham-1.png')

KeywordUtil.markPassed('scenario 4 - Berhasil input pemegang saham 1')
...
'Melakukan screenshoot full page'
WebUI.takeFullPageScreenshotAsCheckpoint((userDir + GlobalVariable.sprint4WebScreenshootPath) + 'scenario-4-Masuk-Submenu-financial.png')

KeywordUtil.markPassed('scenario 4 - Masuk submenu financial')
...
'Melakukan screenshoot full page'
WebUI.takeFullPageScreenshotAsCheckpoint((userDir + GlobalVariable.sprint4WebScreenshootPath) + 'scenario-4-berhasil-input-capture-laporan-keuangan.png')

KeywordUtil.markPassed('scenario 4 - berhasil input capture laporan keuangan')
...
'Melakukan screenshoot full page'
WebUI.takeFullPageScreenshotAsCheckpoint((userDir + GlobalVariable.sprint4WebScreenshootPath) + 'scenario-4-behasil-input-capture-laporan-bukti-kepemilikan.png')

KeywordUtil.markPassed('scenario 4 - berhasil input capture laporan bukti kepemilikan')
...
'Melakukan screenshoot full page'
WebUI.takeFullPageScreenshotAsCheckpoint((userDir + GlobalVariable.sprint4WebScreenshootPath) + 'scenario-4-berhasil-input-branch-dan-account-10digit-pada-submenu-financial.png')

KeywordUtil.markPassed('scenario 4 - berhasil input branch dan account 10 digit pada submenu financial')
...
'Melakukan screenshoot full page'
WebUI.takeFullPageScreenshotAsCheckpoint((userDir + GlobalVariable.sprint4WebScreenshootPath) + 'scenario-4-berhasil-input-contact-person.png')

KeywordUtil.markPassed('scenario 4 - berhasil input contact person')
...
'Melakukan screenshoot full page'
WebUI.takeFullPageScreenshotAsCheckpoint((userDir + GlobalVariable.sprint4WebScreenshootPath) + 'scenario-4-Masuk-menu-other-document.png')

KeywordUtil.markPassed('scenario 4 - Masuk menu other document')

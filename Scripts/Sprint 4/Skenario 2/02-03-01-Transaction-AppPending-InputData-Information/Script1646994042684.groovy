...
WebUI.takeFullPageScreenshotAsCheckpoint((userDir + GlobalVariable.sprint4WebScreenshootPath) + 'scenario-2-masuk-menu-collateral-dan-loan.png')

KeywordUtil.markPassed('scenario 2 - Masuk menu collateral dan loan')
...
'Melakukan screenshoot full page'
WebUI.takeFullPageScreenshotAsCheckpoint((userDir + GlobalVariable.sprint4WebScreenshootPath) + 'scenario-2-input-jenis-pengajuan.png')

KeywordUtil.markPassed('scenario 2 - Input Jenis Pengajuan')
...
'Melakukan screenshoot full page'
WebUI.takeFullPageScreenshotAsCheckpoint((userDir + GlobalVariable.sprint4WebScreenshootPath) + 'scenario-2-input-tujuan-pengajuan.png')

KeywordUtil.markPassed('scenario 2 - Input Tujuan Pengajuan')
...
WebUI.takeFullPageScreenshotAsCheckpoint((userDir + GlobalVariable.sprint4WebScreenshootPath) + 'scenario-2-input-payment.png')

KeywordUtil.markPassed('scenario 2 - Input Payment')
...
'Melakukan screenshoot full page'
WebUI.takeFullPageScreenshotAsCheckpoint((userDir + GlobalVariable.sprint4WebScreenshootPath) + 'scenario-2-input-data-autodebit.png')

KeywordUtil.markPassed('scenario 2 - Input data autodebit')
...
'Melakukan screenshoot full page'
WebUI.takeFullPageScreenshotAsCheckpoint((userDir + GlobalVariable.sprint4WebScreenshootPath) + 'scenario-2-masuk-submenu-input-mutasi-rekening.png')

KeywordUtil.markPassed('scenario 2 - Masuk submenu input mutasi rekening')
...
'Melakukan screenshoot full page'
WebUI.takeFullPageScreenshotAsCheckpoint((userDir + GlobalVariable.sprint4WebScreenshootPath) + 'scenario-2-sebelum-input-data-mutasi-rekening.png')

KeywordUtil.markPassed('scenario 2 - sebelum input data mutasi rekening')
...
'Melakukan screenshoot full page'
WebUI.takeFullPageScreenshotAsCheckpoint((userDir + GlobalVariable.sprint4WebScreenshootPath) + 'scenario-2-input-data-mutasi-rekening.png')

KeywordUtil.markPassed('scenario 2 - input data mutasi rekening')
...
'Melakukan screenshoot full page'
WebUI.takeFullPageScreenshotAsCheckpoint((userDir + GlobalVariable.sprint4WebScreenshootPath) + 'scenario-2-berhasil-mengisi-data-information.png')

KeywordUtil.markPassed('scenario 2 - Berhasil mengisi data information')

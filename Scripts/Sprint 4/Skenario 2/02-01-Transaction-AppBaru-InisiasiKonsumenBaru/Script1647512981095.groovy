...
WebUI.takeFullPageScreenshotAsCheckpoint((userDir + GlobalVariable.sprint4WebScreenshootPath) + 'scenario-2-aplikasi-baru-login.png')

KeywordUtil.markPassed('scenario 2 - Memastikan login berhasil')
...
'Melakukan screenshoot full page'
WebUI.takeFullPageScreenshotAsCheckpoint((userDir + GlobalVariable.sprint4WebScreenshootPath) + 'scenario-2-memilih-button-transaksi-dan-aplikasi-baru.png')

KeywordUtil.markPassed('scenario 2 - Memilih button transaksi dan aplikasi baru')
...
'Melakukan screenshoot full page'
WebUI.takeFullPageScreenshotAsCheckpoint((userDir + GlobalVariable.sprint4WebScreenshootPath) + 'scenario-2-input-badan-usaha.png')

KeywordUtil.markPassed('scenario 2 - Input badan usaha')
...
'Melakukan screenshoot full page'
WebUI.takeFullPageScreenshotAsCheckpoint((userDir + GlobalVariable.sprint4WebScreenshootPath) + 'scenario-2-page-sebelum-input-capture.png')

KeywordUtil.markPassed('scenario 2 - Sebelum input capture npwp + SIUP + TDP')
...
'Melakukan screenshoot full page'
WebUI.takeFullPageScreenshotAsCheckpoint((userDir + GlobalVariable.sprint4WebScreenshootPath) + 'scenario-2-Capture-npwp-siup-tdp.png')

KeywordUtil.markPassed('scenario 2 - Capture NPWP + SIUP + TDP')
...
'Melakukan screenshoot full page'
WebUI.takeFullPageScreenshotAsCheckpoint((userDir + GlobalVariable.sprint4WebScreenshootPath) + 'scenario-2-Memilih-Radio-Button-Perubahan-Data.png')

KeywordUtil.markPassed('scenario 2 - Memilih Radio Button Perubahan Data')
...
'Melakukan screenshoot full page'
WebUI.takeFullPageScreenshotAsCheckpoint((userDir + GlobalVariable.sprint4WebScreenshootPath) + 'scenario-2-Masuk-aplikasi-matching.png')

KeywordUtil.markPassed('scenario 2 - Masuk aplikasi matching')
...
'Melakukan screenshoot full page'
WebUI.takeFullPageScreenshotAsCheckpoint((userDir + GlobalVariable.sprint4WebScreenshootPath) + 'scenario-2-Berhasil-dilakukan-inisiasi-konsumen-baru.png')

KeywordUtil.markPassed('scenario 2 - Berhasil dilakukan inisiasi konsumen baru')

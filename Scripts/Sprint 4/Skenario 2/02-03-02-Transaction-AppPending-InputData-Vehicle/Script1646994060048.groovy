...
WebUI.takeFullPageScreenshotAsCheckpoint((userDir + GlobalVariable.sprint4WebScreenshootPath) + 'scenario-2-masuk-halaman-collateral-loan-vehicle.png')

KeywordUtil.markPassed('scenario 2 - Masuk halaman collateral loan vehicle')
...
'Melakukan screenshoot full page'
WebUI.takeFullPageScreenshotAsCheckpoint((userDir + GlobalVariable.sprint4WebScreenshootPath) + 'scenario-2-halaman-input-data-vehicle.png')

KeywordUtil.markPassed('scenario 2 - halaman input data vehicle')
...
'Melakukan screenshoot full page'
WebUI.takeFullPageScreenshotAsCheckpoint((userDir + GlobalVariable.sprint4WebScreenshootPath) + 'scenario-2-berhasil-input-data-vehicle.png')

KeywordUtil.markPassed('scenario 2 - berhasil input data vehicle')
...
'Melakukan screenshoot full page'
WebUI.takeFullPageScreenshotAsCheckpoint((userDir + GlobalVariable.sprint4WebScreenshootPath) + 'scenario-2-halaman-input-loan-data.png')

KeywordUtil.markPassed('scenario 2 - halaman input loan data')
...
'Melakukan screenshoot full page'
WebUI.takeFullPageScreenshotAsCheckpoint((userDir + GlobalVariable.sprint4WebScreenshootPath) + 'scenario-2-berhasil-input-data-loan.png')

KeywordUtil.markPassed('scenario 2 - berhasil input data loan')
...
'Melakukan screenshoot full page'
WebUI.takeFullPageScreenshotAsCheckpoint((userDir + GlobalVariable.sprint4WebScreenshootPath) + 'scenario-2-halaman-input-insurance.png')

KeywordUtil.markPassed('scenario 2 - halaman input insurance')
...
'Melakukan screenshoot full page'
WebUI.takeFullPageScreenshotAsCheckpoint((userDir + GlobalVariable.sprint4WebScreenshootPath) + 'scenario-2-halaman-input-life-insurance.png')

KeywordUtil.markPassed('scenario 2 - halaman input life insurance')
...
'Melakukan screenshoot full page'
WebUI.takeFullPageScreenshotAsCheckpoint((userDir + GlobalVariable.sprint4WebScreenshootPath) + 'scenario-2-berhasil-input-data-insurance.png')

KeywordUtil.markPassed('scenario 2 - berhasil input data insurance')
...
'Melakukan screenshoot full page'
WebUI.takeFullPageScreenshotAsCheckpoint((userDir + GlobalVariable.sprint4WebScreenshootPath) + 'scenario-2-submenu-notes.png')

KeywordUtil.markPassed('scenario 2 - submenu notes')
...
KeywordUtil.markPassed('scenario 2 - berhasil input  notes CMO')
...
'Melakukan screenshoot full page'
WebUI.takeFullPageScreenshotAsCheckpoint((userDir + GlobalVariable.sprint4WebScreenshootPath) + 'scenario-2-pop-up-add-kendaraan.png')

KeywordUtil.markPassed('scenario 2 - Popup add unit kendaraan')
...
'Melakukan screenshoot full page'
WebUI.takeFullPageScreenshotAsCheckpoint((userDir + GlobalVariable.sprint4WebScreenshootPath) + 'scenario-2-berhasil-add-kendaraan.png')

KeywordUtil.markPassed('scenario 2 - berhasil add unit kendaraan')
...
'Melakukan screenshoot full page'
WebUI.takeFullPageScreenshotAsCheckpoint((userDir + GlobalVariable.sprint4WebScreenshootPath) + 'scenario-2-pop-up-summary-total.png')

KeywordUtil.markPassed('scenario 2 - Popup summary total')

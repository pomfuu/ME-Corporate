...
WebUI.takeFullPageScreenshotAsCheckpoint((userDir + GlobalVariable.sprint4WebScreenshootPath) + 'scenario-1-masuk-menu-collateral-dan-loan.png')

KeywordUtil.markPassed('scenario 1 - Masuk menu collateral dan loan')
...
'Melakukan screenshoot full page'
WebUI.takeFullPageScreenshotAsCheckpoint((userDir + GlobalVariable.sprint4WebScreenshootPath) + 'scenario-1-input-jenis-pengajuan.png')

KeywordUtil.markPassed('scenario 1 - Input Jenis Pengajuan')
...
'Melakukan screenshoot full page'
WebUI.takeFullPageScreenshotAsCheckpoint((userDir + GlobalVariable.sprint4WebScreenshootPath) + 'scenario-1-input-tujuan-pengajuan.png')

KeywordUtil.markPassed('scenario 1 - Input Tujuan Pengajuan')
...
WebUI.takeFullPageScreenshotAsCheckpoint((userDir + GlobalVariable.sprint4WebScreenshootPath) + 'scenario-1-input-payment.png')

KeywordUtil.markPassed('scenario 1 - Input Payment')
...
'Melakukan screenshoot full page'
WebUI.takeFullPageScreenshotAsCheckpoint((userDir + GlobalVariable.sprint4WebScreenshootPath) + 'scenario-1-input-data-autodebit.png')

KeywordUtil.markPassed('scenario 1 - Input data autodebit')
...
'Melakukan screenshoot full page'
WebUI.takeFullPageScreenshotAsCheckpoint((userDir + GlobalVariable.sprint4WebScreenshootPath) + 'scenario-1-masuk-submenu-input-mutasi-rekening.png')

KeywordUtil.markPassed('scenario 1 - Masuk submenu input mutasi rekening')
...
'Melakukan screenshoot full page'
WebUI.takeFullPageScreenshotAsCheckpoint((userDir + GlobalVariable.sprint4WebScreenshootPath) + 'scenario-1-sebelum-input-data-mutasi-rekening.png')

KeywordUtil.markPassed('scenario 1 - sebelum input data mutasi rekening')
...
'Melakukan screenshoot full page'
WebUI.takeFullPageScreenshotAsCheckpoint((userDir + GlobalVariable.sprint4WebScreenshootPath) + 'scenario-1-input-data-mutasi-rekening.png')

KeywordUtil.markPassed('scenario 1 - input data mutasi rekening')
...
'Melakukan screenshoot full page'
WebUI.takeFullPageScreenshotAsCheckpoint((userDir + GlobalVariable.sprint4WebScreenshootPath) + 'scenario-1-berhasil-mengisi-data-information.png')

KeywordUtil.markPassed('scenario 1 - Berhasil mengisi data information')

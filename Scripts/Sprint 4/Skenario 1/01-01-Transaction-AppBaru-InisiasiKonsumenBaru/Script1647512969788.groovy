...
WebUI.takeFullPageScreenshotAsCheckpoint((userDir + GlobalVariable.sprint4WebScreenshootPath) + 'scenario-1-aplikasi-baru-login.png')

KeywordUtil.markPassed('Scenario 1 - Memastikan login berhasil')
...
'Melakukan screenshoot full page'
WebUI.takeFullPageScreenshotAsCheckpoint((userDir + GlobalVariable.sprint4WebScreenshootPath) + 'scenario-1-memilih-button-transaksi-dan-aplikasi-baru.png')

KeywordUtil.markPassed('Scenario 1 - Memilih button transaksi dan aplikasi baru')
...
WebUI.setText(findTestObject('MEApp_AppBaru_InisiasiKonsumen/input-badanusaha'), 'Perseroan Terbatas')

'Melakukan delay 1 detik'
WebUI.delay(1)

'Melakukan screenshoot full page'
WebUI.takeFullPageScreenshotAsCheckpoint((userDir + GlobalVariable.sprint4WebScreenshootPath) + 'scenario-1-input-badan-usaha.png')

KeywordUtil.markPassed('Scenario 1 - Input badan usaha')

'Melakukan delay 2 detik'
WebUI.delay(2)

'Memilih badan usaha'
WebUI.click(findTestObject('MEApp_AppBaru_InisiasiKonsumen/span_Perseroan Terbatas'))

'Melakukan delay 2 detik'
WebUI.delay(2)

'Melakukan screenshoot full page'
WebUI.takeFullPageScreenshotAsCheckpoint((userDir + GlobalVariable.sprint4WebScreenshootPath) + 'scenario-1-page-sebelum-input-capture.png')

KeywordUtil.markPassed('Scenario 1 - Sebelum input capture npwp + SIUP + TDP')
...
WebUI.setText(findTestObject('MEApp_AppBaru_InisiasiKonsumen/input_NPWP No fix'), NPWP_tidakBerlaku)

'Melakukan delay 1 detik'
WebUI.delay(1)

'Input data nama NPWP tidak berlaku'
WebUI.setText(findTestObject('MEApp_AppBaru_InisiasiKonsumen/input_Name fix'), CN_tidakBerlaku)
...
'Melakukan screenshoot full page'
WebUI.takeFullPageScreenshotAsCheckpoint((userDir + GlobalVariable.sprint4WebScreenshootPath) + 'scenario-1-Capture-npwp-siup-tdp.png')

KeywordUtil.markPassed('Scenario 1 - Capture NPWP + SIUP + TDP')
...
'Melakukan screenshoot full page'
WebUI.takeFullPageScreenshotAsCheckpoint((userDir + GlobalVariable.sprint4WebScreenshootPath) + 'scenario-1-Memilih-Radio-Button-Perubahan-Data.png')

KeywordUtil.markPassed('Scenario 1 - Memilih Radio Button Perubahan Data')
...
'Melakukan screenshoot full page'
WebUI.takeFullPageScreenshotAsCheckpoint((userDir + GlobalVariable.sprint4WebScreenshootPath) + 'scenario-1-Masuk-aplikasi-matching.png')

KeywordUtil.markPassed('Scenario 1 - Masuk aplikasi matching')
...
KeywordUtil.markPassed('Scenario 1 - Berhasil dilakukan inisiasi konsumen baru')

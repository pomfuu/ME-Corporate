...
WebUI.takeFullPageScreenshotAsCheckpoint((userDir + GlobalVariable.sprint4WebScreenshootPath) + 'scenario-3-masuk-submenu-surat-keterangan-domisili.png')

KeywordUtil.markPassed('scenario 3 - Masuk submenu surat keterangan domisili')
...
'Melakukan screenshoot full page'
WebUI.takeFullPageScreenshotAsCheckpoint((userDir + GlobalVariable.sprint4WebScreenshootPath) + 'scenario-3-capture-surat-keterangan-domisili-berhasil.png')

KeywordUtil.markPassed('scenario 3 - Capture surat keterangan domisili berhasil')
...
'Melakukan screenshoot full page'
WebUI.takeFullPageScreenshotAsCheckpoint((userDir + GlobalVariable.sprint4WebScreenshootPath) + 'scenario-3-Masuk-submenu-FAP.png')

KeywordUtil.markPassed('scenario 3 - Masuk submenu FAP')
...
'Melakukan screenshoot full page'
WebUI.takeFullPageScreenshotAsCheckpoint((userDir + GlobalVariable.sprint4WebScreenshootPath) + 'scenario-3-Input-data-FAP.png')

KeywordUtil.markPassed('scenario 3 - Input data FAP')
...
'Melakukan screenshoot full page'
WebUI.takeFullPageScreenshotAsCheckpoint((userDir + GlobalVariable.sprint4WebScreenshootPath) + 'scenario-3-Input-data-alamat-pengirim-surat.png')

KeywordUtil.markPassed('scenario 3 - Input data alamat pengirim surat')
...
'Melakukan screenshoot full page'
WebUI.takeFullPageScreenshotAsCheckpoint((userDir + GlobalVariable.sprint4WebScreenshootPath) + 'scenario-3-Input-data-pengurus.png')

KeywordUtil.markPassed('scenario 3 - Input data pengurus')
...
'Melakukan screenshoot full page'
WebUI.takeFullPageScreenshotAsCheckpoint((userDir + GlobalVariable.sprint4WebScreenshootPath) + 'scenario-3-Masuk-submenu-data-pengurus-1.png')

KeywordUtil.markPassed('scenario 3 - Masuk submenu data pengurus 1')
...
WebUI.takeFullPageScreenshotAsCheckpoint((userDir + GlobalVariable.sprint4WebScreenshootPath) + 'scenario-3-Berhasil-input-otomatis-data-pengurus-berdasarkan-data-capture-ktp-pengurus-yang-di-capture.png')

KeywordUtil.markPassed('scenario 3 - Berhasil input otomatis data pengurus berdasarkan data capture ktp pengurus yang di capture ')
...
'Melakukan screenshoot full page'
WebUI.takeFullPageScreenshotAsCheckpoint((userDir + GlobalVariable.sprint4WebScreenshootPath) + 'scenario-3-Berhasil-input-otomatis-data-pengurus-1.png')

KeywordUtil.markPassed('scenario 3 - Berhasil input data pengurus 1')
...
'Melakukan screenshoot full page'
WebUI.takeFullPageScreenshotAsCheckpoint((userDir + GlobalVariable.sprint4WebScreenshootPath) + 'scenario-3-Masuk-Submenu-pemegang-saham-1.png')

KeywordUtil.markPassed('scenario 3 - Berhasil masuk menu pemegang saham ')
...
'Melakukan screenshoot full page'
WebUI.takeFullPageScreenshotAsCheckpoint((userDir + GlobalVariable.sprint4WebScreenshootPath) + 'scenario-3-Memilih-radio-button-pemegang-saham.png')

KeywordUtil.markPassed('scenario 3 - Memilih radio button pemegang saham')
...
KeywordUtil.markPassed('scenario 3 - Masuk submenu pemegang saham 1')
...
'Melakukan screenshoot full page'
WebUI.takeFullPageScreenshotAsCheckpoint((userDir + GlobalVariable.sprint4WebScreenshootPath) + 'scenario-3-Berhasil-pemegang-saham-1.png')

KeywordUtil.markPassed('scenario 3 - Berhasil input pemegang saham 1')
...
'Melakukan screenshoot full page'
WebUI.takeFullPageScreenshotAsCheckpoint((userDir + GlobalVariable.sprint4WebScreenshootPath) + 'scenario-3-Masuk-Submenu-financial.png')

KeywordUtil.markPassed('scenario 3 - Masuk submenu financial')
...
'Melakukan screenshoot full page'
WebUI.takeFullPageScreenshotAsCheckpoint((userDir + GlobalVariable.sprint4WebScreenshootPath) + 'scenario-3-berhasil-input-capture-laporan-keuangan.png')

KeywordUtil.markPassed('scenario 3 - berhasil input capture laporan keuangan')
...
'Melakukan screenshoot full page'
WebUI.takeFullPageScreenshotAsCheckpoint((userDir + GlobalVariable.sprint4WebScreenshootPath) + 'scenario-3-behasil-input-capture-laporan-bukti-kepemilikan.png')

KeywordUtil.markPassed('scenario 3 - berhasil input capture laporan bukti kepemilikan')
...
'Melakukan screenshoot full page'
WebUI.takeFullPageScreenshotAsCheckpoint((userDir + GlobalVariable.sprint4WebScreenshootPath) + 'scenario-3-berhasil-input-branch-dan-account-10digit-pada-submenu-financial.png')

KeywordUtil.markPassed('scenario 3 - berhasil input branch dan account 10 digit pada submenu financial')
...
'Melakukan screenshoot full page'
WebUI.takeFullPageScreenshotAsCheckpoint((userDir + GlobalVariable.sprint4WebScreenshootPath) + 'scenario-3-berhasil-input-contact-person.png')

KeywordUtil.markPassed('scenario 3 - berhasil input contact person')
...
'Melakukan screenshoot full page'
WebUI.takeFullPageScreenshotAsCheckpoint((userDir + GlobalVariable.sprint4WebScreenshootPath) + 'scenario-3-Masuk-menu-other-document.png')

KeywordUtil.markPassed('scenario 3 - Masuk menu other document')

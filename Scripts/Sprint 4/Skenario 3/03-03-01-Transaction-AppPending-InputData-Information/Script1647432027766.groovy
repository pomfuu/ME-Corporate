...
WebUI.takeFullPageScreenshotAsCheckpoint((userDir + GlobalVariable.sprint4WebScreenshootPath) + 'scenario-3-masuk-menu-collateral-dan-loan.png')

KeywordUtil.markPassed('scenario 3 - Masuk menu collateral dan loan')
...
'Melakukan screenshoot full page'
WebUI.takeFullPageScreenshotAsCheckpoint((userDir + GlobalVariable.sprint4WebScreenshootPath) + 'scenario-3-input-jenis-pengajuan.png')

KeywordUtil.markPassed('scenario 3 - Input Jenis Pengajuan')
...
'Melakukan screenshoot full page'
WebUI.takeFullPageScreenshotAsCheckpoint((userDir + GlobalVariable.sprint4WebScreenshootPath) + 'scenario-3-input-tujuan-pengajuan.png')

KeywordUtil.markPassed('scenario 3 - Input Tujuan Pengajuan')
...
WebUI.takeFullPageScreenshotAsCheckpoint((userDir + GlobalVariable.sprint4WebScreenshootPath) + 'scenario-3-input-payment.png')

KeywordUtil.markPassed('scenario 3 - Input Payment')
...
'Melakukan screenshoot full page'
WebUI.takeFullPageScreenshotAsCheckpoint((userDir + GlobalVariable.sprint4WebScreenshootPath) + 'scenario-3-input-data-autodebit.png')

KeywordUtil.markPassed('scenario 3 - Input data autodebit')
...
'Melakukan screenshoot full page'
WebUI.takeFullPageScreenshotAsCheckpoint((userDir + GlobalVariable.sprint4WebScreenshootPath) + 'scenario-3-masuk-submenu-input-mutasi-rekening.png')

KeywordUtil.markPassed('scenario 3 - Masuk submenu input mutasi rekening')
...
'Melakukan screenshoot full page'
WebUI.takeFullPageScreenshotAsCheckpoint((userDir + GlobalVariable.sprint4WebScreenshootPath) + 'scenario-3-sebelum-input-data-mutasi-rekening.png')

KeywordUtil.markPassed('scenario 3 - sebelum input data mutasi rekening')
...
'Melakukan screenshoot full page'
WebUI.takeFullPageScreenshotAsCheckpoint((userDir + GlobalVariable.sprint4WebScreenshootPath) + 'scenario-3-input-data-mutasi-rekening.png')

KeywordUtil.markPassed('scenario 3 - input data mutasi rekening')
...
'Melakukan screenshoot full page'
WebUI.takeFullPageScreenshotAsCheckpoint((userDir + GlobalVariable.sprint4WebScreenshootPath) + 'scenario-3-berhasil-mengisi-data-information.png')

KeywordUtil.markPassed('scenario 3 - Berhasil mengisi data information')

...
WebUI.takeFullPageScreenshotAsCheckpoint((userDir + GlobalVariable.sprint4WebScreenshootPath) + 'scenario-3-aplikasi-baru-login.png')

KeywordUtil.markPassed('scenario 3 - Memastikan login berhasil')
...
'Melakukan screenshoot full page'
WebUI.takeFullPageScreenshotAsCheckpoint((userDir + GlobalVariable.sprint4WebScreenshootPath) + 'scenario-3-memilih-button-transaksi-dan-aplikasi-baru.png')

KeywordUtil.markPassed('scenario 3 - Memilih button transaksi dan aplikasi baru')
...
'Melakukan screenshoot full page'
WebUI.takeFullPageScreenshotAsCheckpoint((userDir + GlobalVariable.sprint4WebScreenshootPath) + 'scenario-3-input-badan-usaha.png')

KeywordUtil.markPassed('scenario 3 - Input badan usaha')
...
'Melakukan screenshoot full page'
WebUI.takeFullPageScreenshotAsCheckpoint((userDir + GlobalVariable.sprint4WebScreenshootPath) + 'scenario-3-page-sebelum-input-capture.png')

KeywordUtil.markPassed('scenario 3 - Sebelum input capture npwp + SIUP + TDP')
...
'Melakukan screenshoot full page'
WebUI.takeFullPageScreenshotAsCheckpoint((userDir + GlobalVariable.sprint4WebScreenshootPath) + 'scenario-3-Capture-npwp-siup-tdp.png')

KeywordUtil.markPassed('scenario 3 - Capture NPWP + SIUP + TDP')
...
'Melakukan screenshoot full page'
WebUI.takeFullPageScreenshotAsCheckpoint((userDir + GlobalVariable.sprint4WebScreenshootPath) + 'scenario-3-Memilih-Radio-Button-Perubahan-Data.png')

KeywordUtil.markPassed('scenario 3 - Memilih Radio Button Perubahan Data')
...
'Melakukan screenshoot full page'
WebUI.takeFullPageScreenshotAsCheckpoint((userDir + GlobalVariable.sprint4WebScreenshootPath) + 'scenario-3-Masuk-aplikasi-matching.png')

KeywordUtil.markPassed('scenario 3 - Masuk aplikasi matching')
...
'Melakukan screenshoot full page'
WebUI.takeFullPageScreenshotAsCheckpoint((userDir + GlobalVariable.sprint4WebScreenshootPath) + 'scenario-3-Berhasil-dilakukan-inisiasi-konsumen-baru.png')

KeywordUtil.markPassed('scenario 3 - Berhasil dilakukan inisiasi konsumen baru')

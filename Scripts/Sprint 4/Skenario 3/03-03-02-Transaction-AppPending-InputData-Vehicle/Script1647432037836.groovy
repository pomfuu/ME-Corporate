...
WebUI.takeFullPageScreenshotAsCheckpoint((userDir + GlobalVariable.sprint4WebScreenshootPath) + 'scenario-3-masuk-halaman-collateral-loan-vehicle.png')

KeywordUtil.markPassed('scenario 3 - Masuk halaman collateral loan vehicle')
...
WebUI.setText(findTestObject('ME_CollateralAndLoan_Vehicle/input_dealername_ketiga'), 'Akita Prima Mobilindo, PT', FailureHandling.OPTIONAL)
...
WebUI.setText(findTestObject('ME_CollateralAndLoan_Vehicle/input_branch_ketiga'), 'Akita Prima Mobilindo - Pondok Cabe')
...
'Melakukan screenshoot full page'
WebUI.takeFullPageScreenshotAsCheckpoint((userDir + GlobalVariable.sprint4WebScreenshootPath) + 'scenario-3-halaman-input-data-vehicle.png')

KeywordUtil.markPassed('scenario 3 - halaman input data vehicle')
...
WebUI.setText(findTestObject('ME_CollateralAndLoan_Vehicle/input_productcode2'), 'leasing')
...
WebUI.setText(findTestObject('vehiclekedua/input_brand_kedua'),'toyota')
...
WebUI.setText(findTestObject('vehiclekedua/input_model_kedua'),'ALL NEW HILUX',FailureHandling.OPTIONAL)
...
WebUI.setText(findTestObject('ME_CollateralAndLoan_Vehicle/input_typekendaraan'),'ALL NEW HI LUX DOUBLE CABIN 2.4 G (4X4) M/T DIESEL 2017',FailureHandling.OPTIONAL)
...
WebUI.click(findTestObject('ME_CollateralAndLoan_Vehicle/div_ALL NEW HI LUX DOUBLE CABIN 2.4 G (4X4) MT DIESEL 2017_type_datavehicle'),FailureHandling.OPTIONAL)
...
WebUI.setText(findTestObject('vehiclekedua/input_packet_kedua'),'BCAI - IIMS - SUBS OTR ADDB', FailureHandling.OPTIONAL)
...
WebUI.setText(findTestObject('ME_CollateralAndLoan_Vehicle/input_Keterangan Type Kendaraan_keteranganType'), 'bekas')

'Melakukan delay 1 detik'
WebUI.delay(1)

'Melakukan input year'
WebUI.setText(findTestObject('ME_CollateralAndLoan_Vehicle/input_Year_year (1)'), '2020')
...
WebUI.setText(findTestObject('ME_CollateralAndLoan_Vehicle/input_Color_text-input (1)'), 'hitam')

'Melakukan delay 1 detik'
WebUI.delay(1)

'Melakukan input BPKB No.'
WebUI.setText(findTestObject('ME_CollateralAndLoan_Vehicle/input_BPKB No_text-input'), '1111111111')

'Melakukan delay 1 detik'
WebUI.delay(1)

'Melakukan input Engine no.'
WebUI.setText(findTestObject('ME_CollateralAndLoan_Vehicle/input_Engine No_text-input'), '1111111111')

'Melakukan delay 1 detik'
WebUI.delay(1)

'Melakukan input Police no.'
WebUI.setText(findTestObject('ME_CollateralAndLoan_Vehicle/input_Police No_text-input'), 'B1234AB')

'Melakukan delay 1 detik'
WebUI.delay(1)

'Melakukan input body no'
WebUI.setText(findTestObject('ME_CollateralAndLoan_Vehicle/input_Body No_text-input'), '1111111111')
...
WebUI.setText(findTestObject('vehiclekedua/input_purpose_kedua'),'operasional', FailureHandling.OPTIONAL)
...
WebUI.setText(findTestObject('ME_CollateralAndLoan_Vehicle/input_BPKB Owner_text-input'), 'sendiri')
...
WebUI.setText(findTestObject('vehiclekedua/input_hubungan_bpkbownerdgdebitur_kedua'),'pasangan', FailureHandling.OPTIONAL)
...
'Melakukan screenshoot full page'
WebUI.takeFullPageScreenshotAsCheckpoint((userDir + GlobalVariable.sprint4WebScreenshootPath) + 'scenario-3-berhasil-input-data-vehicle.png')

KeywordUtil.markPassed('scenario 3 - berhasil input data vehicle')
...
'Melakukan screenshoot full page'
WebUI.takeFullPageScreenshotAsCheckpoint((userDir + GlobalVariable.sprint4WebScreenshootPath) + 'scenario-3-halaman-input-loan-data.png')

KeywordUtil.markPassed('scenario 3 - halaman input loan data')
...
WebUI.setText(findTestObject('ME_CollateralAndLoan_Vehicle/input_On The Road Price_otr'), '150000000')

'Melakukan delay 1 detik'
WebUI.delay(1)

'Melakukan input'
WebUI.setText(findTestObject('ME_CollateralAndLoan_Vehicle/input_Down Payment_dpNominal'), '0')

'Melakukan delay 1 detik'
WebUI.delay(1)

'Melakukan input DP Percent'
WebUI.setText(findTestObject('ME_CollateralAndLoan_Vehicle/input_DP_dpPercent'), '30')

'Melakukan delay 1 detik'
WebUI.delay(1)

'Melakukan input tenor bulan'
WebUI.setText(findTestObject('ME_CollateralAndLoan_Vehicle/input_Tenor (bulan)_tenor1'), '48')
...
WebUI.setText(findTestObject('ME_CollateralAndLoan_Vehicle/input_Flat Rate_flatRate'), '7')

'Melakukan delay 1 detik'
WebUI.delay(1)

'Melakukan input flatrate 2'
WebUI.setText(findTestObject('ME_CollateralAndLoan_Vehicle/input_Flat Rate 2_flatRate2'), '7')
...
WebUI.setText(findTestObject('ME_CollateralAndLoan_Vehicle/input_Provisional Percent_provisionPercent'), '2')
...
WebUI.setText(findTestObject('ME_CollateralAndLoan_Vehicle/input_Adm Fee_admFee'), '2000000')
...
'Melakukan screenshoot full page'
WebUI.takeFullPageScreenshotAsCheckpoint((userDir + GlobalVariable.sprint4WebScreenshootPath) + 'scenario-3-berhasil-input-data-loan.png')

KeywordUtil.markPassed('scenario 3 - berhasil input data loan')
...
'Melakukan screenshoot full page'
WebUI.takeFullPageScreenshotAsCheckpoint((userDir + GlobalVariable.sprint4WebScreenshootPath) + 'scenario-3-halaman-input-insurance.png')

KeywordUtil.markPassed('scenario 3 - halaman input insurance')

'Melakukan delay 1 detik'
WebUI.delay(1)

'Melakukan input search car insurance 1'
WebUI.setText(findTestObject('vehiclekedua/input_carinsurance_kedua'), 'NO INSURANCE')
...
WebUI.setText(findTestObject('vehiclekedua/input_carinsurancebranch_kedua'),'NO INSURANCE', FailureHandling.OPTIONAL)
...
WebUI.setText(findTestObject('vehiclekedua/input_carinsurancetype_kedua'),'all risk')
...
'Melakukan screenshoot full page'
WebUI.takeFullPageScreenshotAsCheckpoint((userDir + GlobalVariable.sprint4WebScreenshootPath) + 'scenario-3-halaman-input-life-insurance.png')

KeywordUtil.markPassed('scenario 3 - halaman input life insurance')
...
WebUI.setText(findTestObject('vehiclekedua/input_lifeinsurancecorp_kedua'),'ASURANSI LAINNYA', FailureHandling.OPTIONAL)
...
WebUI.setText(findTestObject('vehiclekedua/input_lifeinsurancebranch_kedua'),'AS. LAINNYA',FailureHandling.OPTIONAL)
...
'Melakukan screenshoot full page'
WebUI.takeFullPageScreenshotAsCheckpoint((userDir + GlobalVariable.sprint4WebScreenshootPath) + 'scenario-3-berhasil-input-data-insurance.png')

KeywordUtil.markPassed('scenario 3 - berhasil input data insurance')
...
'Melakukan screenshoot full page'
WebUI.takeFullPageScreenshotAsCheckpoint((userDir + GlobalVariable.sprint4WebScreenshootPath) + 'scenario-3-submenu-notes.png')

KeywordUtil.markPassed('scenario 3 - submenu notes')

'Melakukan delay 1 detik'
WebUI.delay(1)

'Melakukan input note'
WebUI.setText(findTestObject('ME_CollateralAndLoan_Vehicle/textarea_Note CMO_noteCMO'), 'notes cmo note cmo')
...
KeywordUtil.markPassed('scenario 3 - berhasil input  notes CMO')
...
'Melakukan screenshoot full page'
WebUI.takeFullPageScreenshotAsCheckpoint((userDir + GlobalVariable.sprint4WebScreenshootPath) + 'scenario-3-pop-up-add-kendaraan.png')

KeywordUtil.markPassed('scenario 3 - Popup add unit kendaraan')
...
WebUI.setText(findTestObject('vehiclekedua/input_Jumlah unit_kedua'), '2')
...
WebUI.setText(findTestObject('vehiclekedua/input_Add_select2-search__field-UNIT_yangakandicopy_kedua'), 'Unit 1')
...
'Melakukan screenshoot full page'
WebUI.takeFullPageScreenshotAsCheckpoint((userDir + GlobalVariable.sprint4WebScreenshootPath) + 'scenario-3-berhasil-add-kendaraan.png')

KeywordUtil.markPassed('scenario 3 - berhasil add unit kendaraan')
...
'Melakukan screenshoot full page'
WebUI.takeFullPageScreenshotAsCheckpoint((userDir + GlobalVariable.sprint4WebScreenshootPath) + 'scenario-3-pop-up-summary-total.png')

KeywordUtil.markPassed('scenario 3 - Popup summary total')
